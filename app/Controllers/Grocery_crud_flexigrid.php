...
class Grocery_crud_flexigrid extends BaseController
{
	public function __construct() {
		
		parent::__construct();
		$this->data['title'] = 'Grocery CRUD Flexigrid';
	}
			...
			switch ($name) {
				...
				case 'css_files':
					foreach ($value as $css_file) {
						...
						if (strpos($css_file, 'flatpickr') && strpos($css_file, 'theme')) {
							$this->addStyle(['attr' => ['id' => 'style-head-flatpickr'], 'url' => $css_file]);
						}
					}
					break;
				case 'output':
