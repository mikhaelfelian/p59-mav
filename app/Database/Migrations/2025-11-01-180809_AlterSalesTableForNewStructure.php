 ...
 * Description: Migration to alter sales table from old structure to new Sales System structure
 */
class AlterSalesTableForNewStructure extends Migration
{
    public function up()
    {
        // Drop old sales_items and sales_payments tables first (if they exist)
        $this->forge->dropTable('sales_payments', true);
        $this->forge->dropTable('sales_items', true);
        
        // Alter sales table structure
