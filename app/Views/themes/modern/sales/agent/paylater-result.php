 ...
 * Description: View for agent paylater transactions list/result with DataTables
 */
?>
<div class="card">
	<div class="card-header">
		<h5 class="card-title">Data Paylater</h5>
	</div>
	...
	<div class="card-body">	
		...
		<span id="dataTables-url" style="display:none"><?= $config->baseURL ?>agent/paylater/getDataDT</span>
	</div>
</div>
