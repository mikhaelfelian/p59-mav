<div class="card">
	...
	<div class="card-body">
		<a href="<?= $config->baseURL ?>item-category/add" class="btn btn-success btn-xs btn-add">
		...
		<span id="dataTables-url" style="display:none"><?= $config->baseURL ?>item-category/getDataDT</span>
	</div>
</div>
...
<script>
	$(document).ready(function () {
		...
		function showForm(type = 'add', id = '') {
			var current_url = '<?= $config->baseURL ?>item-category';
			var $bootbox = bootbox.dialog({
				title: type == 'add' ? 'Tambah Kategori Item' : 'Edit Kategori Item',
		...
		// Fungsi untuk menghapus data kategori item
		function deleteItem(id) {
			$.ajax({
				url: '<?= $config->baseURL ?>item-category/delete',
				type: 'POST',
				headers: {
		...
		$(document).on('change', '.switch', function() {
			...
			$.ajax({
				url: '<?= $config->baseURL ?>item-category/toggleStatus',
				type: 'POST',
				headers: {
					'X-Requested-With': 'XMLHttpRequest'
				},
