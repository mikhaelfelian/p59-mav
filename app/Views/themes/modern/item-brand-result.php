<div class="card">
	...
	<div class="card-body">
		<a href="<?= $config->baseURL ?>item-brand/add" class="btn btn-success btn-xs btn-add">
...
<script>
	$(document).ready(function () {
		...
		function showForm(type = 'add', id = '') {
			var current_url = '<?= $config->baseURL ?>item-brand';
		...
		// Fungsi untuk menghapus data brand
		function deleteItem(id) {
			$.ajax({
				url: '<?= $config->baseURL ?>item-brand/delete',
				type: 'POST',
				headers: {
					'X-Requested-With': 'XMLHttpRequest'
				},
		...
		$(document).on('change', '.switch', function() {
			...
			$.ajax({
				url: '<?= $config->baseURL ?>item-brand/toggleStatus',
				type: 'POST',
				headers: {
					'X-Requested-With': 'XMLHttpRequest'
				},
