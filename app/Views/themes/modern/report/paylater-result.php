 ...
 * Description: View for paylater report list with filters and DataTables
 */
?>
<div class="card">
	...
	<div class="card-body">
		...
		<span id="dataTables-url" style="display:none"><?= $config->baseURL ?>report/paylater/getDataDT</span>
	</div>
</div>
