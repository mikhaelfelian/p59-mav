<div class="card">
	...
	<div class="card-body">
		<a href="<?= $config->baseURL ?>item-spec/add" class="btn btn-success btn-xs btn-add">
		...
		<span id="dataTables-url" style="display:none"><?= $config->baseURL ?>item-spec/getDataDT</span>
	</div>
</div>
...
<script>
	$(document).ready(function () {
		...
		function showForm(type = 'add', id = '') {
			var current_url = '<?= $config->baseURL ?>item-spec';
			var $bootbox = bootbox.dialog({
				title: type == 'add' ? 'Tambah Spesifikasi Item' : 'Edit Spesifikasi Item',
		...
		// Fungsi untuk menghapus data spesifikasi item
		function deleteItem(id) {
			$.ajax({
				url: '<?= $config->baseURL ?>item-spec/delete',
				type: 'POST',
				headers: {
					'X-Requested-With': 'XMLHttpRequest'
				},
		...
		$(document).on('change', '.switch', function() {
			...
			$.ajax({
				url: '<?= $config->baseURL ?>item-spec/toggleStatus',
				type: 'POST',
				headers: {
					'X-Requested-With': 'XMLHttpRequest'
				},
