...
$routes->group('agent', function($routes) {
    ...
    $routes->post('sales/bayar/cek/(:num)', 'Agent\Sales::refreshPaymentStatus/$1');
    $routes->get('sales/bayar/cek/(:num)', 'Agent\Sales::refreshPaymentStatus/$1');
    ...
    $routes->post('paylater/pay-mass', 'Agent\Paylater::payMass');
