...
jQuery(document).ready(function () {
	...
	// Check if overlayScrollbars is available before using it
	if (typeof $.fn.overlayScrollbars !== 'undefined') {
		$('.sidebar, .overlayscollbar').overlayScrollbars({scrollbars : {autoHide: 'leave', autoHideDelay: 100} });
	} else {
		console.warn('OverlayScrollbars plugin is not loaded.');
	}
	...
	// Check if DataTable is available before extending defaults
